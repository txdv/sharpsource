...
GCCXML=gccxml
CXXILIB=/home/bentkus/Projects/mono/cxxi/bin/Debug/Mono.Cxxi.dll
CXXIBIN=/home/bentkus/Projects/mono/cxxi/bin/Debug/generator.exe
CXXI=mono $(CXXIBIN)
...
blet: bindings.xml
	$(CXXI) --out=blet -lib=AlliedMods bindings.xml

copy:
	rm -rvf output/
	cp -rvf generated/ output/

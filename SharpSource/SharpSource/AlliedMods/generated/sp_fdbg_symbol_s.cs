// -------------------------------------------------------------------------
//  Managed wrapper for sp_fdbg_symbol_s
...
namespace AlliedMods {
	public partial class sp_fdbg_symbol_s : ICppObject {

		private static readonly Isp_fdbg_symbol_s impl = Libs.AlliedMods.GetClass<Isp_fdbg_symbol_s,_sp_fdbg_symbol_s,sp_fdbg_symbol_s> ("sp_fdbg_symbol_s");
		public CppInstancePtr Native { get; protected set; }

		[MangleAs ("struct sp_fdbg_symbol_s")]
		public partial interface Isp_fdbg_symbol_s : ICppClassOverridable<sp_fdbg_symbol_s> {
		...
		public unsafe struct _sp_fdbg_symbol_s {
			public int addr;
			public short tagid;
		...
		public sp_fdbg_symbol_s (CppTypeInfo subClass)
		{
			__cxxi_LayoutClass ();
			subClass.AddBase (impl.TypeInfo);
		}

		public sp_fdbg_symbol_s (CppInstancePtr native)
		{
			__cxxi_LayoutClass ();
			Native = native;
		}
